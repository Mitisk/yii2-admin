...
/** @var $userCount int Количество пользователей */
/** @var $userCountThisWeek int Количество пользователей за неделю */
?>
<div class="wg-chart-default dashboard-top-widget-item" data-name="IndexUserWidget">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap14">
            ...
            <div>
                <div class="body-text mb-2">Пользователей</div>
                <h4><?= number_format($userCount, 0, '.', ' ') ?></h4>
            </div>
        </div>
        <?php if ($userCountThisWeek) : ?>
        <div class="box-icon-trending up" title="Количество пользователей за неделю">
            <i class="icon-plus"></i>
            <div class="body-title number">
                <?= number_format($userCountThisWeek, 0, '.', ' ') ?>
            </div>
        </div>
        <?php endif; ?>
    </div>
