...
use kak\rbac\controllers\base\BaseController;
use Mitisk\Yii2Admin\models\rbac\AuthItem;
use Yii;
...
class RoleController extends BaseController
{
    ...
    {
        $this->view->title = $this->view->params['pageHeaderText'] = 'Роли';
    ...
    {
        $this->view->title =  $this->view->params['pageHeaderText'] = 'Новая роль';
    ...
    {
        $this->view->title =  $this->view->params['pageHeaderText'] = 'Редактирование роли';
